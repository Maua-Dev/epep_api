...
if grep -qE "STACK_NAME=${FORBIDDEN_STACK_PREFIX}" .github/workflows/CD.yml; then
  echo "::error::Change STACK_NAME prefix in .github/workflows/CD.yml (still '${FORBIDDEN_STACK_PREFIX}')."
  failed=1
fi
